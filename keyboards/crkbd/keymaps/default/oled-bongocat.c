...
// https://github.com/filterpaper/qmk_userspace/tree/53009b0ef0642688d8a03bf39dd78b35bf76c7bd/oled
...
bool oled_task_user(void) {
	...
	is_keyboard_master() ? render_bongocat() :  decode_frame(paws); //render_mod_status();
	return false;
}